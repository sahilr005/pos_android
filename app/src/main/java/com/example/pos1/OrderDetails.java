...
public class OrderDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contain_extra_grid = findViewById(R.id.contain_extra_grid);

        ArrayAdapter<String> toppingAdapter = new ArrayAdapter<>(this, R.layout.grid_item_layout, R.id.grid_item_text, fetchToppingData());
        contain_extra_grid.setAdapter(toppingAdapter);
    ...
    @SuppressLint("Range")
    private List<String> fetchToppingData() {
        List<String> toppingList = new ArrayList<>();

        // Assuming you have a DatabaseHelper instance
        DatabaseHelper dbHelper = new DatabaseHelper(this);

        // Replace "your_topping_table_name" with the actual table name
        String query = "SELECT tname FROM topping_mast";
        ...
        try {
            ...
            // Iterate through the cursor to retrieve topping names
            if (cursor != null && cursor.moveToFirst()) {
                do {
                 String tname = cursor.getString(cursor.getColumnIndex("tname"));
                    toppingList.add(tname);
